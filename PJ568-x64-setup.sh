...
# Download File
wget http://pj568.eu.org/Blog-Store/PJ568-linux-x64.tar.gz -P ~/cache/
...
sudo echo "Exec=/usr/bin/PJ568的博客-linux-x64/PJ568的博客" >> /usr/share/applications/PJ568_BLOG.desktop
...
sudo echo "Icon=/usr/bin/PJ568的博客-linux-x64/resources/app/icon.ico" >> /usr/share/applications/PJ568_BLOG.desktop
